...
(function(mod) {
    ...
    function positionLineWidget(widget, node, lineView, dims) {
        if (widget.noHScroll) { (lineView.alignable || (lineView.alignable = [])).push(node);
    ...
    TextareaInput.prototype = copyObj({
        init: function(display) {
            ...
            on(display.lineSpace, "selectstart",
            function(e) {
                if (!eventInWidget(display, e)) {
                    e_preventDefault(e)
                }
    ...
    ContentEditableInput.prototype = copyObj({
        init: function(display) {
            ...
            on(div, "compositionupdate",
            function(e) {
                input.composing.data = e.data
            });
            on(div, "compositionend",
            function(e) {
    ...
    function drawSelectionRange(cm, range, output) {
        ...
        function drawForLine(line, fromArg, toArg) {
            ...
            iterateBidiSections(getOrder(lineObj), fromArg || 0, toArg == null ? lineLen: toArg,
    ...
    function highlightWorker(cm) {
        ...
        var changedLines = [];
        doc.iter(doc.frontier, Math.min(doc.first + doc.size, cm.display.viewTo + 500),
        function(line) {
    ...
    function registerEventHandlers(cm) {
        ...
        if (ie && ie_version < 11) {
            on(d.scroller, "dblclick", operation(cm,
            function(e) {
    ...
    function shiftDoc(doc, distance) {
        ...
        doc.first += distance;
        doc.sel = new Selection(map(doc.sel.ranges,
        function(range) {
    ...
    function makeChangeSingleDocInEditor(cm, change, spans) {
        ...
        if (!cm.options.lineWrapping) {
            ...
            doc.iter(checkWidthStart, to.line + 1,
            function(line) {
    ...
    CodeMirror.prototype = {
        ...
        setGutterMarker: methodOp(function(line, gutterID, value) {
            return changeLine(this.doc, line, "gutter",
            function(line) {
        ...
        setSize: methodOp(function(width, height) {
            ...
            cm.doc.iter(lineNo, cm.display.viewTo,
            function(line) {
                if (line.widgets) {
                    for (var i = 0; i < line.widgets.length; i++) {
    ...
    option("moveInputWithCursor", true,
    function(cm, val) {
        if (!val) {
    ...
    function addLineWidget(cm, handle, node, options) {
        ...
        changeLine(cm.doc, handle, "widget",
        function(line) {
    ...
    function highlightLine(cm, line, state, forceToEnd) {
        ...
        for (var o = 0; o < cm.state.overlays.length; ++o) {
            ...
            i = 1,
            at = 0;
            runMode(cm, line.text, overlay.mode, true,
            function(end, style) {
                var start = i;
                while (at < end) {
                    var i_end = st[i];
    ...
    function buildLineContent(cm, lineView) {
        ...
        for (var i = 0; i <= (lineView.rest ? lineView.rest.length: 0); i++) {
            ...
            if (i == 0) {
                ...
                lineView.measure.cache = {}
            } else { (lineView.measure.maps || (lineView.measure.maps = [])).push(builder.map); (lineView.measure.caches || (lineView.measure.caches = [])).push({})
            }
        }
    ...
    Doc.prototype = createObj(BranchChunk.prototype, {
        ...
        indexFromPos: function(coords) {
            ...
            this.iter(this.first, coords.line,
            function(line) {
    ...
    function getBetween(doc, start, end) {
        var out = [],
        n = start.line;
        doc.iter(start.line, end.line + 1,
        function(line) {
            var text = line.text;
            if (n == end.line) {
